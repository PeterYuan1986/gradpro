...
def parse_args():
    ...
    parser.add_argument('--ds_iter', type=int, default=1, help='Number of iterations to optimize diversity sensitive loss')
...
def main():
    ...
    args = parse_args()
    print("step1:parse_args_done")

    automatic_gpu_usage()
    print("step2:automatic_gpu_usage_done")
    gan = StarGAN_v2(args)
    print("step3:StarGAN_v2_done")
    # build graph
    gan.build_model()
